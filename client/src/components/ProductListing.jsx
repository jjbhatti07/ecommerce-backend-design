          ...
          {viewMode === 'list' ? (
            ...
            <div className="space-y-3">
              {products.map((product) => (
                <div key={product.id} className="bg-white border border-[#DEE2E7] rounded-lg p-5 flex gap-6 hover:shadow-md transition-shadow group cursor-pointer relative" onClick={() => { setPage('details'); localStorage.setItem('selectedProduct', product._id); }}>
                  {/* Product Image area */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {products.map((product) => (
                <div
                  ...
                  onClick={() => { setPage('details'); localStorage.setItem('selectedProduct', product._id); }}
                >
                  {/* Product Image Area */}
