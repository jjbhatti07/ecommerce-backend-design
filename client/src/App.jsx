...
function App() {
  ...
  const renderContent = () => {
    switch (currentPage) {
      case 'listing':
        return <ProductListing setPage={setCurrentPage} searchTerm={searchTerm} />;
      case 'details':
      ...
      case 'addproduct':
        return user
          ? <AddProduct setPage={setCurrentPage} />
          : <Auth setPage={setCurrentPage} setUser={setUser} />;
      default:
        return (
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Header setPage={setCurrentPage} onSearch={setSearchTerm} user={user} setUser={setUser} />
